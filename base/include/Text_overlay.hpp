    ...
    void load(base::Physical_device *p_phy_dev, base::Device *p_dev, vk::CommandPool cmd_pool, const std::string &file_path)
    {
        ...
        p_tex->load(ktx_path,
                    ...
                    vk::SamplerCreateInfo({},
                                          ...
                                          vk::SamplerAddressMode::eClampToBorder,
                                          vk::SamplerAddressMode::eClampToBorder,
                                          0.f, VK_FALSE, 1.f, 0, vk::CompareOp::eNever, 0.f, 1.f));
    }
...
public:
    ...
    vk::VertexInputAttributeDescription vi_attribs[1];
    static const uint32_t vi_binding_count = 1;
    static const uint32_t vi_attrib_count = 1;
