...
public:
    ...
    public:
        vk::Image image;
        vk::ImageView view;
        Color_attachment(Device* p_dev,
                         vk::Image& swapchain_image,
                         vk::Format& format) :
            p_dev_(p_dev),
            image(swapchain_image)
        {
            view = p_dev_->dev.createImageView(vk::ImageViewCreateInfo({},
                                                                       swapchain_image,
                                                                       vk::ImageViewType::e2D,
                                                                       format,
                                                                       {},
    ...
    void resize(uint32_t width_hint, uint32_t height_hint, bool force = false)
    {
        ...
        if (curr_extent_.width == new_extent.width && curr_extent_.height == new_extent.height && ! force)
            return;
        ...
        // pre_transform
        auto pre_transform = static_cast<vk::SurfaceTransformFlagBitsKHR>((caps.supportedTransforms & vk::SurfaceTransformFlagBitsKHR::eIdentity) ?
